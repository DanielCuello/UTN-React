           ...
           <AuthContext.Consumer>
                {
                    ...
                    <Navbar bg="primary" expand="lg">
                        <Navbar.Brand href="#home"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-brand-react-native" width="84" height="84" viewBox="0 0 24 24" stroke-width="2.5" stroke="#00abfb" fill="none" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        {
                            context.isLogin &&
                            <div className="Bienvenido">Bienvenido/a {context?.userInfo?.name}</div>
                        }
                    </Navbar>
                }
            </AuthContext.Consumer>
